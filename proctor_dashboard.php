...
#myInput{
    ...
    <section class="table"><br><br><br>
		<a href="proctorlogin.php" style="text-decoration:none; font-size:20px; padding-top:30px; float:right; color:rgb(255,255,255,0.7); display:inline; border:2px;"><i class="fas fa-sign-out-alt" style="padding: 10px;"></i>Logout</a>
		<a href="proctortochangepass.php" style="text-decoration:none; font-size:20px; padding-top:30px; float:right; color:rgb(255,255,255,0.7); display:inline;"><i class="fa fa-lock" style="padding: 10px;"></i>Password</a>
        <div><h1 align="center" style="font-size:35px;padding-bottom: 30px;padding-left: 30px;color:rgb(255,255,255,0.7);margin-left: 50px;">Students List</h1>
        <input type="text" id="myInput"  onkeyup="myFunction()" placeholder="Search for USN..">
        ...
        <div class="scroll">
            ...
            ?>
        <table border="1" id="myTable" style="border-collapse: collapse; padding-top: 50px; margin-left:480px;">
            <tr>
                <th></th>
                <th>USN</th>
                ...
                if($total!=0){
                   // echo'<table border=0 width=100%>';
                    while($result=mysqli_fetch_assoc($run)){
                        echo"
                        <tr>
                            <td><a href='proc_update_student.php ? stuid=$result[StudentID]'><i class='fas fa-eye' style='color:black;'></i></a></td>
