            ...
            <?php
                if($total1!=0){
                     while($result=mysqli_fetch_assoc($data1)){
                         echo"
                         <tr>
                            <td><a href='update_staff.php ? staffid=$result[StaffID]'><i class='fas fa-edit' style='color:black;'></i></a></td>
                            <td><a href='delete_staff.php ? staffid=$result[StaffID]'><i class='fas fa-trash-alt' style='color:black;'></i></a></td>
