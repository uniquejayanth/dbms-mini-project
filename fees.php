...
<body>
    ...
    <div class="container">
        ...
        <ol>
            ...
            <li class="active"><a href="fees.php"><i class="fa fa-money" style="padding-right:10px;"></i>Fees</a></li>
    ...
    <section class="table">
        <div><h1 style="padding-bottom: 30px;padding-left: 30px;color:white;">Fee Status</h1></div>
        ...
        <table border="1" style="border-collapse: collapse;">
            ...
            <tr>
                <td>1</td>
                <td>Management</td>
                <td>Tuition Fees/cultural acivities/NSS Fee/College Fee</td>
                <td>4,00,000.00</td>
                <td>2,00,000.00</td>
                <td>2,00,000.00</td>
            </tr>
