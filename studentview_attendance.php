...
<body>
	<div>
        <nav>
            ...
            <?php
                ...
                $query1="select sub.SubDesc,sub.SubID,sd.ClassesHeld,sd.ClassesAttended,sd.AttendancePercentage from subject sub,study sd where sub.SubID=sd.SubjectID and sd.StudentID='$studid'";
	...
	<div class="container">
		...
		<ol>
			<li class="active"><a href="studentview_attendance.php"><i class="fa fa-hand-paper-o"></i>Attendance</a></li>
                ...
                if($total1!=0){
                    while($result=mysqli_fetch_assoc($data1)){
                        ...
                        <tr>
                            ...
                            <td>".$result['SubID']."</td>
                            <td>".$result['ClassesHeld']."</td>
                            <td>".$result['ClassesAttended']."</td>
                            <td>".$result['AttendancePercentage']."</td>
                            </tr>
                            ";
                    }
                }
