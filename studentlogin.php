...
<form action="studentlogin.php" method="POST">
            ...
            <input type="text" style="margin-top:250px;" class="p_username" placeholder="username" name="username" required>
            <br><br> <br> 

            <input type="password" style="margin-top:300px;" class="p_username" placeholder="password" name="password" required>
            <br><br> <br> 
